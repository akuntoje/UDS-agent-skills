...
Read all references from the uds-components skill and review each section component
in `src/components/`:
...
| 🟡 Warning | Bespoke markup where UDS could work, missing alt text     | Fix if time allows  |
| 🟢 Info    | Minor visual delta from design, outdated package version  | Document and accept |
